...
export function NewsTicker({ news = [] }: NewsTickerProps) {
    ...
    return (
        <section className="py-24 bg-slate-50 dark:bg-slate-950/50 relative overflow-hidden border-t border-border/40">
            ...
            <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-amber-700/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        <div className="space-y-6">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-700/10 border border-amber-700/20 shadow-sm">
                                ...
                                <span className="text-xs font-bold uppercase tracking-widest text-amber-700">Live Updates</span>
                            </div>

                            <h2 className="text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-black text-foreground tracking-tight leading-[1.1]">
                                Our Latest <br />
                                <span className="text-amber-700 italic">Happenings.</span>
                            </h2>
                            ...
                            <div className="h-full overflow-hidden ticker-mask">
                                <div className="animate-vertical-news hover:paused flex flex-col gap-4 px-4 md:px-6 py-8">
                                    {displayNews.map((item, index) => {
                                        const CardContent = (
                                            <div className="group relative p-6 rounded-[2rem] bg-amber-700/10 border border-border/50 shadow-sm hover:shadow-2xl hover:shadow-amber-700/5 hover:-translate-y-1 transition-all duration-500 flex items-start gap-4 overflow-hidden">
                                                {/* Icon */}
                                                <div className="shrink-0 mt-0.5 relative z-10">
                                                    <div className="h-12 w-12 rounded-2xl bg-amber-700 text-white flex items-center justify-center transition-all duration-500 group-hover:scale-110 shadow-lg shadow-amber-700/20">
                                                ...
                                                <div className="flex-1 min-w-0 space-y-1 relative z-10">
                                                    <h3 className="text-lg font-black text-amber-700 leading-snug transition-colors pr-5">
                                                        {item.title}
                                                    </h3>
                                                    ...
                                                    {item.link && (
                                                        <div className="pt-2 flex items-center gap-1 text-[10px] font-bold text-amber-700 hover:underline underline-offset-4 transition-all uppercase tracking-wider">
                                                ...
                                                <div className="absolute top-0 right-0 w-20 h-20 bg-amber-700/20 rounded-bl-[3rem] opacity-60 group-hover:opacity-100 transition-all duration-500" />
                                            </div>
                                        );
                                        ...
                                        return item.link ? (
                                            <a
                                                ...
                                                className="block focus:outline-none focus:ring-2 focus:ring-amber-700 focus:ring-offset-2 rounded-[2rem]"
                                            >
                                                {CardContent}
                                            </a>
                                        ) : (
