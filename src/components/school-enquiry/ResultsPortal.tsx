      ...
      <section className="relative pt-28 pb-8 lg:pt-40 lg:pb-12 px-6">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Enter your registration number to view your official GK Competition
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1">
                  <div className="rounded-3xl border border-border bg-white dark:bg-white/5 p-8 shadow-sm h-full flex flex-col items-center text-center">
                    ...
                    <Badge
                      variant="outline"
                      className="font-mono px-3 py-1 bg-slate-50 dark:bg-slate-900 border-border text-xs"
                    >
                  ...
                  <div className="rounded-3xl border border-border bg-white dark:bg-white/5 p-8 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8 h-full bg-linear-to-br from-white to-slate-50 dark:from-white/5 dark:to-transparent">
                    <div className="flex-1 space-y-4 text-center md:text-left">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        This scorecard represents your achievement in the GK
                        Competition organized by Jharkhand Jan Kalyan Trust. We
              ...
              <div className="mt-8 text-center">
                <p className="text-xs text-muted-foreground flex items-center justify-center gap-2">
                  ...
                  This is a system-generated result portal • Symbosys Jan Kalyan
                  Trust • Verified on {format(new Date(), "PP")}
                </p>
              </div>
            </div>
          ) : (
            <div
              className={`py-16 text-center transition-opacity duration-300 ${loading ? "opacity-40" : "opacity-100"}`}
            >
              ...
              <p className="text-muted-foreground text-base max-w-[300px] mx-auto leading-relaxed">
                {loading
                  ? "Securely retrieving your examination data..."
                  : "Enter your registration number above to access your official examination scorecard."}
              </p>
            </div>
          )}
        </div>
