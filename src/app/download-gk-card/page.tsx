...
import { RegistrationCardPortal } from "@/components/school-enquiry/RegistrationCardPortal";

export default function DownloadRegistrationCardPage() {
    return (
