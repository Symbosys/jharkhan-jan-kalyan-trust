...
import { EventInfiniteList } from "@/components/client/events/EventInfiniteList";
                ...
                <div className="container mx-auto px-6 lg:px-8 relative z-10 pt-32 pb-20 lg:pt-48 lg:pb-32">
                    ...
                    <div className="text-center mb-24 space-y-6">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/40 dark:bg-white/5 border border-white/60 dark:border-white/10 backdrop-blur-md shadow-xl shadow-black/5 mb-2">
                            ...
                            <span className="text-xs font-bold uppercase tracking-[0.2em] text-foreground/80">Upcoming & Recent</span>
                        </div>
                        ...
                        <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto font-medium leading-relaxed">
                            Join us in our upcoming community programs, seminars, and initiatives designed to create a lasting impact.
                        </p>
                    </div>
                    ...
                    <div className="relative">
                        <EventInfiniteList
                            initialData={(response?.events || []) as any[]}
