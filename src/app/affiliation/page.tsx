...
import { AffiliationForm } from "@/components/client/affiliation/AffiliationForm";

export const metadata = {
    title: "Request Affiliation | Jharkhand Jan Kalyan Trust",
    description:
        "Apply for affiliation with Jharkhand Jan Kalyan Trust. Join our network of partner organizations working for social welfare and community development.",
};
