...
import { AffiliationCardPortal } from "@/components/affiliation/AffiliationCardPortal";

export default function DownloadAffiliationCardPage() {
    return (
